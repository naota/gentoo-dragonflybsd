...
PATCHES=( "${FILESDIR}"/${P}-bsdcmp.patch
	"${FILESDIR}"/${P}-fixmakefiles.patch
	"${FILESDIR}"/${P}-kdump-ioctl.patch
	"${FILESDIR}"/${P}-xinstall.patch 
	"${FILESDIR}"/${P}-doscmd.patch 
